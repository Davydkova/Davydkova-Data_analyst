...
# Pet проект [Product.Рассчитать и спрогнозировать LTV мобильного приложения](https://github.com/Davydkova/Davydkova-Data_analyst/blob/main/LTV_Product/LTV_prediction(1).ipynb) (in procesing)
